...
def build(image_set, args):
    ...
    PATHS = {
        ...
        "train_reg": (root / "images/train2017", root / "annotations" / f'{mode}_train2017.json'),
        "val": (root / "images/val2017", root / "annotations" / f'{mode}_val2017.json'),
        "eval_debug": (root / "images/val2017", root / "annotations" / f'{mode}_val2017.json'),
        "test": (root / "images/test2017", root / "annotations" / 'image_info_test-dev2017.json' ),
    }
